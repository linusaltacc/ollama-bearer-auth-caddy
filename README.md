...
If you're interested in using `OLLAMA_API_KEY` as a local environment variable, check out this repo: [ollama-bearer-auth](https://github.com/bartolli/ollama-bearer-auth).
